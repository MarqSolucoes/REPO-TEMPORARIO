...
namespace WHEngenharia.Services.PrevisaoFluxoCaixa
{
    partial class Service : ServiceBase
    {
        ...
        protected override void OnStart(string[] args)
        {
            ...
            ThreadPool.QueueUserWorkItem(o => GeraPrevisaoFluxoCaixa());
        }
        ...
        private static void GeraPrevisaoFluxoCaixa()
        {
            while (true)
            {
                var arquivoLog = $"C:\\WH Engenharia\\Servicos\\PrevisaoFluxoCaixa\\Log\\{DateTime.Now.ToString("dd-MM-yyyy")}.txt";
                ...
                try
                {
                    ...
                    var response = client.PostAsync("http://whengenharia.solinski.com.br:5500/api/Services/GeraPrevisaoFluxoCaixa", null).Result;
